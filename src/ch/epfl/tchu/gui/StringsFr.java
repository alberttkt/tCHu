...
public final class StringsFr {
    ...
    public static final String PLANE_CARD = "avion";
     ...
     * @return a String of the cards in good format (i.e. 1 verte, 2 oranges et 1 locomotive)
     */
    public static String sortedBagName(SortedBag<Card> cards) {
